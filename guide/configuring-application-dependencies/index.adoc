...
dependencies {
   ...
   testImplementation "software.amazon.awssdk:s3:2.18.16"
   // Reason for including AWS Java SDK V1: https://github.com/testcontainers/testcontainers-java/issues/1442
   testImplementation "com.amazonaws:aws-java-sdk-s3:1.11.100"
...
For complete code please refer to the GitHub repository https://github.com/testcontainers/tc-guide-configuring-application-dependencies
